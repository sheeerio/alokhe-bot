...
exports.CreateCompletionRequest = void 0;
const core = __importStar(require("../../../../../core"));
exports.CreateCompletionRequest = core.serialization.object({
    model: core.serialization.string(),
    prompt: core.serialization.lazy(async () => (await Promise.resolve().then(() => __importStar(require("../../../..")))).Prompt).optional(),
