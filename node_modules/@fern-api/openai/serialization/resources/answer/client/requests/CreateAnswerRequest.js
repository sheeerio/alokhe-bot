...
exports.CreateAnswerRequest = core.serialization.object({
    model: core.serialization.string(),
    question: core.serialization.string(),
    examples: core.serialization.list(core.serialization.list(core.serialization.lazyObject(async () => (await Promise.resolve().then(() => __importStar(require("../../../..")))).ExampleItems))),
    ...
    stop: core.serialization.lazy(async () => (await Promise.resolve().then(() => __importStar(require("../../../..")))).CompletionStop).optional(),
