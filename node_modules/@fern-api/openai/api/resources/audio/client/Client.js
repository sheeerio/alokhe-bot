...
class Audio {
     ...
     */
    async transcribe(file, request, opts) {
        ...
        const _response = await (this.options.fetcher ?? core.fetcher)({
            url: (0, url_join_1.default)(environments.OpenAIEnvironment.Production, "/audio/transcriptions"),
            method: "POST",
            headers: {
     ...
     * @throws {OpenAI.InternalServerError}
     */
    async translate(file, request, opts) {
        const _request = new form_data_1.default();
        _request.append("file", file);
        _request.append("model", request.model);
        if (request.prompt != null) {
        ...
        const _response = await (this.options.fetcher ?? core.fetcher)({
            url: (0, url_join_1.default)(environments.OpenAIEnvironment.Production, "/audio/translations"),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "OpenAI-Organization": await core.Supplier.get(this.options.organization),
